...
app.getAppLayout(() => {
    app.getObject('fDJRCp').then(function (model) {
        fetchAllData(model, 30).then(matrix => {
            let horse_table_data_matrix = matrix;

            let keys = ['horse', 'bred', 'age', 'trainer', 'owner', 'breeder', 'sire', 'dam', 'dams_sire'];
                    ...
                    <div class="col vs_horse_details">
                        <div class="vs_horse_details_first_col">
                            <div class="vs_horse_name_age">
                                <div class="vs_horse_name">${horse_table_data[index].horse} <span>(${horse_table_data[index].bred})</span></div>
                                <div class="vs_horse_age">Age: <span>${horse_table_data[index].age} yo</span></div>
                            </div>
                        </div>
                        <div class="vs_horse_details_second_col">
                            <div class="vs_horse_TOB_details">
                                <div class="vs_horse_TOB">Trainer: <span>${horse_table_data[index].trainer}</span></div>
                                <div class="vs_horse_TOB">Owner: <span>${horse_table_data[index].owner}</span></div>
                                <div class="vs_horse_TOB">Breeder: <span>${horse_table_data[index].breeder}</span></div>
                            </div>
                            <div class="vs_horse_SDD">
                                <div class="vs_horse_sire">Sire: <span>${horse_table_data[index].sire}</span></div>
                                <div class="vs_horse_dam">Dam: <span>${horse_table_data[index].dam}</span></div>
                                <div class="vs_horse_damsire">Dam's Sire: <span>${horse_table_data[index].dams_sire}</span></div>
                            </div>
                        </div>
                        <button class="horse_view_report" horse_name="${horse_table_data[index].horse}">View Report</button>
                    </div>`;
...
$('.vs_content').on('click', '.horse_view_report', function () {
    ...
    app.field('horse_name').selectMatch(fieldName, true);
